class Player < ActiveRecord::Base
	has_many :pro_players, dependent: :destroy
	has_many :pro_teams, through: :pro_players, dependent: :destroy
	...
	def self.import_from_json(data)
		ActiveRecord::Base.transaction do
			...
			pro_player.player_stat = PlayerStat.create(data["player_stats"])
		end
	end
end
