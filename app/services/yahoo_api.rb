class YahooApi
	...
	def pull_stats(season_id, player_id)
		...
		# result.merge!"player_name"] = player_data["name"]["full"]
		# result.merge!["yahoo_player_id"] = player_data["player_id"]
		# result.merge!["uniform_number"] = player_data["uniform_number"]
		# result.merge!["headshot_url"] = player_data["headshot"]["url"]
		# result.merge!["positions"] = player_data["eligible_positions"]["position"]
		# result.merge!["pro_team"] = {}
		# result.merge!["pro_team"]["name"] = player_data["editorial_team_full_name"] # TODO
		# result.merge!["pro_team"]["abbreviation"] = player_data["editorial_team_abbr"] # TODO
		# result.merge!["pro_team"]["yahoo_team_id"] = player_data["editorial_team_key"] # TODO
		# result.merge!["pro_player"]["season"] = stats_data[0]["season"] # TODO
		# result.merge!["player_stats"] = stats_data
